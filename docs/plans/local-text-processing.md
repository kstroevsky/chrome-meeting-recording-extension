...
5. ~~**Build seams.**~~ **Done.** §7 — only what step 4 proved: webpack worker entry and asset copying, worker tsconfig, and any CSP the spike demonstrated. No weights-origin define, no host permission, no production-build check for either (BLD-02/BLD-03 superseded).
