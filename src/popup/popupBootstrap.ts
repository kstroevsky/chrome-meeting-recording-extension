...
export function createPopupController(doc: Document = document): PopupController {
  return new PopupController({
    ...
    notes: {
      ...
      nameRow: byId(doc, 'note-name'),
      nameInput: byId<HTMLInputElement>(doc, 'note-name-input'),
      from: byId(doc, 'note-from'),
      hint: byId(doc, 'note-hint'),
      hintDismiss: byId<HTMLButtonElement>(doc, 'note-hint-dismiss'),
    ...
    uploadHead: byId(doc, 'upload-head'),
    uploadJobLabel: byId(doc, 'upload-job-label'),
    uploadJobSub: byId(doc, 'upload-job-sub'),
    uploadEyebrow: byId(doc, 'upload-eyebrow'),
    uploadFilesLabel: byId(doc, 'upload-files-label'),
    ...
    uploadRecoveryNote: byId(doc, 'upload-recovery-note'),
