/**
 * @file background/library/notations/RecordingNotationRepository.ts
 *
...
import { NOTATIONS_STORE as STORE_NAME, openRecordingHistoryDatabase } from '../RecordingLibraryDatabase';
