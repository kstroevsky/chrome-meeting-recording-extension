...
describe('WorkerStorageTarget', () => {
  let WorkerStorageTarget: typeof import('../src/offscreen/storage/WorkerStorageTarget').WorkerStorageTarget;
  ...
  beforeEach(() => {
    ...
    WorkerStorageTarget = require('../src/offscreen/storage/WorkerStorageTarget').WorkerStorageTarget;
  });
