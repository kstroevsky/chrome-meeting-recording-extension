...
} from '../src/background/recordingAutoStop';
import { addTabRemovedListener, addTabUpdatedListener } from '../src/platform/chrome/tabs';
import type { RecordingSessionSnapshot } from '../src/shared/recording';
